...
//			Evaluating the text file word by word and writing to preface
			readText();
...
//          Manipulating word by word
				switch (data) {
				case ".large":
					fontUsed = new Font(Font.FontFamily.TIMES_ROMAN, 24, Font.BOLD);
					break;
				case ".normal":
				...
				case ".bold":
					...
					break;
				default:
					preface.add(new Paragraph(data, fontUsed));
				}
	...
	// iText allows to add metadata to the PDF which can be viewed in its properties
	...
	private static void addContentToPDF(Document document) throws DocumentException {
		...
		preface.add(new Paragraph("check1).", redFont));
		System.out.println("PRINT");

		preface.add(new Paragraph());

		preface.add(new Paragraph("check2).", redFont));
